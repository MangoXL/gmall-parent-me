...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\electronic_commerce\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("XiaoLe");
        ...
        dsc.setUrl("jdbc:mysql://192.168.190.129:3306/gmall_" + moduleName + "?useUnicode=true&useSSL=false&characterEncoding=utf8");
